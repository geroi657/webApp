...
export default function Left_B({level, backgroundURL, headingContent, paragraphContent, buttonContent, buttonLink}) {
    return (
        <div className="left_B">
            <div className="left_B__container">
                ...
                <Link to={buttonLink}><Button text={ buttonContent }></Button></Link>
            </div>
